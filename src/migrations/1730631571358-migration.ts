...
export class Migration1730631571358 implements MigrationInterface {
    name = 'Migration1730631571358'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`leave_used_info\` (\`id\` int NOT NULL AUTO_INCREMENT, \`usedDays\` int NOT NULL, \`employeeId\` varchar(36) NULL, \`policyId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
