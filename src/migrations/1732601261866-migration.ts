...
export class Migration1732601261866 implements MigrationInterface {
    name = 'Migration1732601261866'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`einformation\` (\`id\` int NOT NULL AUTO_INCREMENT, \`degreeOrCertificate\` varchar(255) NULL, \`experience\` varchar(255) NULL, \`deleted_at\` datetime(6) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`employee_shift\` (\`id\` int NOT NULL AUTO_INCREMENT, \`employee_id\` varchar(36) NULL, \`shift_id\` int NULL, \`created_by\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`employee_shift\` ADD CONSTRAINT \`FK_8528c69a033f536d3f4043ac993\` FOREIGN KEY (\`created_by\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`employee_shift\` DROP FOREIGN KEY \`FK_8528c69a033f536d3f4043ac993\``);
